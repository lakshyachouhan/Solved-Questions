<h2><a href="https://leetcode.com/problems/check-if-a-parentheses-string-can-be-valid/?envType=problem-list-v2&envId=m2lxlt1h">2221. Check if a Parentheses String Can Be Valid</a></h2><h3>Medium</h3><hr><p>A parentheses string is a <strong>non-empty</strong> string consisting only of <code>&#39;(&#39;</code> and <code>&#39;)&#39;</code>. It is valid if <strong>any</strong> of the following conditions is <strong>true</strong>:</p>
